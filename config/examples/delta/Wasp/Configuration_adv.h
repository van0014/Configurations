...
//
  ...
  #define BOARD_MINTEMP           1  // (°C)
  #define BOARD_MAXTEMP          85  // (°C)
...
#define TEMP_SENSOR_AD595_OFFSET  -125.0
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 60*3
...
#define PROBE_RADIUS 75

#define PROBE_PT_1_X 0
#define PROBE_PT_1_Y PROBE_RADIUS

#define PROBE_PT_2_X (int)(-PROBE_RADIUS * 0.866)  // cos(30°) ≈ 0.866
#define PROBE_PT_2_Y (int)(-PROBE_RADIUS * 0.5)    // sin(30°) = 0.5

#define PROBE_PT_3_X (int)(PROBE_RADIUS * 0.866)
#define PROBE_PT_3_Y (int)(-PROBE_RADIUS * 0.5)
 ...
 */
  ...
  #define DIAG_PINS_REMOVED //I've removed the diag pins. This should normally not be defined. Only use it if you removed the pins
