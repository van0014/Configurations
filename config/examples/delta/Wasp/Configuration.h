...
#define STRING_CONFIG_H_AUTHOR "(van0014, DeltaWASP 2040 T2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DeltaWASP 2040 T2"
...
#define HOTEND_OFFSET_X { 0.0, 22.80 } // (mm) relative X-offset for each nozzle
 ...
 */
#define PSU_CONTROL
#define PSU_NAME "ATX 12v + DIN 24v"
 ...
 */
  ...
  #define MPC_HEATER_POWER { 60.0f , 60.0f }                  // (W) Heat cartridge powers.
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 293.7        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 430.20             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 169.0              // (mm) Get this value from G33 auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 85.33, 85.33, 85.33, 104.7 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 5000, 1000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 10000, 10000, 10000, 3000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 14, -16.5 }
...
#define X_BED_SIZE 220*2
#define Y_BED_SIZE 220*2

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -220
#define Y_MIN_POS -220
#define Z_MIN_POS 0
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 360 }
